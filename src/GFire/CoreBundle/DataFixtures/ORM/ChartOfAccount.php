...
class ChartOfAccountData  extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        $manager = $this->container->get('gfire_core.manager.chartofaccount');
